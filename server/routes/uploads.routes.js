...
const storage = multer.diskStorage({
  destination: function(req,file,cb){ //guarda las imagenes en la carpeta uploads
    cb(null,'uploads/')
  },
  filename: function(req,file,cb){ //nombra a las imagenes
...
function checkFileType(file,cb){
  ...
  if(extname && mimetype){ //si pasa ambas validaciones 
    return cb(null,true)
  }else{
    cb('Images only!')
  }
